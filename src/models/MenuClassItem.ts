...
/**
 * Check if a given object implements the MenuClassItem interface.
 */
export function instanceOfMenuClassItem(value: object): boolean {
    let isInstance = true;
...
export function MenuClassItemFromJSON(json: any): MenuClassItem {
    return MenuClassItemFromJSONTyped(json, false);
}

export function MenuClassItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): MenuClassItem {
...
export function MenuClassItemToJSON(value?: MenuClassItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
